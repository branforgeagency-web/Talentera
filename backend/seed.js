...
const REAL_COMPANIES = [
  {
    ...
    kycNotes: "GSTIN and PAN verified via government registry API.",
    completedStages: ["1a", "1b", "2", "3", "9"],
    stage1a: {
      legalname: "Optum Health India Private Limited",
      gstin: "36AAACO1234A1Z5",
      pan: "AAACO1234A",
      entity: "Private Limited",
      doi: "2012-04-15",
      cosize: "5,000+",
      regaddress: "Building 14, Mindspace IT Park, Hitec City, Hyderabad - 500081",
      signatory: { name: "Siddharth Rao", email: "siddharth.rao@optum.com" },
      kycgst: { docName: "Optum_GST_Certificate.pdf", docUrl: "/uploads/sample_gst.pdf" },
      kycpan: { docName: "Optum_PAN_Card.pdf", docUrl: "/uploads/sample_pan.pdf" },
    },
    stage1b: { pocname: "Siddharth Rao", pocemail: "hiring@optum.co.in", pocmobile: "9876500111", pocdesig: "Head of Talent Acquisition" },
  ...
  },
  {
    ...
    stage1a: {
      legalname: "Access Healthcare Services Private Limited",
      gstin: "33AAAAA5678B1Z9",
      pan: "AAAAA5678B",
      entity: "Private Limited",
      doi: "2015-08-20",
      cosize: "1,001–5,000",
      regaddress: "Olympia Tech Park, Guindy, Chennai - 600032",
      signatory: { name: "Deepika Raman", email: "deepika@accesshealthcare.com" },
      kycgst: { docName: "AccessHC_GST.pdf", docUrl: "/uploads/sample_gst.pdf" },
      kycpan: { docName: "AccessHC_PAN.pdf", docUrl: "/uploads/sample_pan.pdf" },
    },
    stage1b: { pocname: "Deepika Raman", pocemail: "careers@accesshealthcare.com", pocmobile: "9888811223", pocdesig: "HR Director" },

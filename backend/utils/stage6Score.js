 ...
 * Mirror of frontend/src/utils/stage6Score.js. The server recomputes on save, so the
 * client value is only a live preview. Keep the two files in sync.
 *
...
const STAGE6_MAX_POINTS = 10;
const STAGE6_VERIFIED_MIN_POINTS = 3;
...
function getTier(totalCharts, overallAccuracy, evidencePath) {
...
function evidenceMultiplier(evidencePath, hasProofDoc) {
 ...
 */
function computeStage6Result(input = {}) {

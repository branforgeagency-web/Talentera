...
export const STAGE_BANNERS = {
  "1a": { icon: "🛡️", title: "Verify your business once. Get trusted forever.", desc: "Companies with verified KYC get a permanent trust badge. Candidates apply 3× more often to verified profiles.", unlocks: ["Permanent trust badge", "Fraud protection guaranteed", "Save drafts & multi-user access", "Pay-on-hire pricing locked"] },
  "1b": { icon: "📞", title: "We notify you the moment shortlists land.", desc: "Your point of contact gets real-time alerts the second a verified candidate matches.", unlocks: ["Real-time SMS + email alerts", "Direct candidate phone numbers", "Two-way candidate chat", "WhatsApp Business integration"] },
  "2": { icon: "🏢", title: "Stand out to top candidates. 3× more applications.", desc: "A complete company profile is what candidates see before they apply — make it count.", unlocks: ["Public branded hiring page", "Custom URL talentera.in/co/your-name", "Higher candidate match scores", "Featured listings"] },
  "3": { icon: "👥", title: "Hire as a team. Move 5× faster.", desc: "Bring recruiters, interviewers and hiring managers in so nothing waits on one inbox.", unlocks: ["Multi-user collaboration", "Role-based permissions (Admin/Recruiter/HM)", "Activity audit log", "Per-user calendar sync"] },
  "4": { icon: "🎨", title: "Branded candidate emails get 2.4× more replies.", desc: "Candidate-facing emails and invitations carry your brand, not a generic template.", unlocks: ["Custom email branding", "careers.yourname.com domain", "Branded interview invites", "Auto-signed emails"] },
  "5": { icon: "❓", title: "1,500 questions ready. Or upload your own.", desc: "Defaults work for 80% of roles — customize only if you need to.", unlocks: ["1,500-question default bank", "Specialty-tagged questions", "Difficulty-calibrated rotation", "Anti-leak shuffling"] },
  "6": { icon: "⚖️", title: "Score by what matters most to you.", desc: "Only needed if the default scoring weights don't fit a particular role.", unlocks: ["Per-role rubric weights", "Override approval workflow", "Calibration reports", "Bias detection alerts"] },
  "7": { icon: "🚦", title: "Going live in minutes — let's tighten the bolts.", desc: "Final settings before candidates start landing in your inbox.", unlocks: ["Live preview link", "SLA-tracked alerts", "Auto-reject filter chain", "Cooling-off enforcement"] },
  "8": { icon: "🔌", title: "Plug into your existing stack.", desc: "All optional except billing — connect calendars, chat and your ATS whenever you're ready.", unlocks: ["Auto calendar holds", "Slack hire alerts", "ATS bidirectional sync", "PO + invoicing automation"] },
  "9": { icon: "📋", title: "First JD live → 5 candidates in 24 hours.", desc: "This is the requisition Talentera's matching engine runs against the verified pool.", unlocks: ["Auto-match <24hrs", "Verified-only shortlists", "Specialty-deep filter stack", "First-click candidate exclusivity"] },
};

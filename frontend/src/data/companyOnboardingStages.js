...
export const ONBOARDING_STAGES = [
  {
    ...
    items: [
      ...
      { id: "kycincorp", name: "KYC: Certificate of Incorporation", desc: "Optional — Pvt Ltd / LLP only", tag: "opt", input: "file" },
    ],
  },
  {
    id: "1b",
  ...
  },
  {
    ...
    items: [
      { id: "hq", name: "Company Headquarters", desc: "City / State of primary office", tag: "must", input: "text", placeholder: "e.g. Chennai, Tamil Nadu" },
      { id: "about", name: "Company Description", desc: "Overview of your organization and culture", tag: "must", input: "textarea", maxlength: 2000, placeholder: "Describe your company, culture, and what you do..." },
      { id: "branches", name: "Branches", desc: "Additional office or facility locations", tag: "opt", input: "text", placeholder: "e.g. Bangalore, Hyderabad, Pune" },
      { id: "projects", name: "Projects", desc: "Key client accounts, domains, or active engagements", tag: "opt", input: "textarea", maxlength: 1000, placeholder: "e.g. Hospital billing transition, Inpatient coding audit, Denial resolution..." },
    ],
  },
  {
    id: "3",
  ...
  },
  {
    id: "4",
    key: "4",
    name: "Company Communication Setup",
    sub: "Official channels for screening, interviews & candidate updates",
    items: [
      {
        id: "officialemail",
        name: "Professional / Official Email Address",
        desc: "For interview, screening and official communication",
        tag: "must",
        input: "email",
      ...
      },
      {
        ...
        desc: "Official signature block appended to candidate communication",
        tag: "must",
        input: "textarea",
        maxlength: 500,
      ...
      },
      {
        ...
        desc: "Optional — mention the terms & conditions to include in your hiring and candidate communication",
        tag: "opt",
        input: "textarea",
        maxlength: 1000,
        placeholder: "e.g. Notice period & background verification, probation and confirmation terms, confidentiality / data-privacy (HIPAA) obligations, work-hours & shift rules, code of conduct, or paste a policy link",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: "pcautoreject", name: "Auto-reject filters", tag: "opt", input: "multi", options: [
        "Education Mismatch (Life Science / Non Lifescience/Both)",
        "Missing mandatory keywords (CPC / ICD-10 / CPT / HCPCS)",
        "Experience (0–2 years for fresher drives)",
        "Location (preferred cities only)",
        "Education Mismatch: Life Science Only",
        "Education Mismatch: Non-Life Science Only",
        "Missing mandatory keyword: CPC",
        "Missing mandatory keyword: ICD-10",
        "Missing mandatory keyword: CPT",
        "Missing mandatory keyword: HCPCS",
        "Below min experience",
        "Missing certification",
        "Wrong location",
        "Notice period exceeds limit",
        "Below compensation floor",
        "Already rejected in last 6mo",
      ] },
...
export const JOB_POSTING_STAGE = {
  id: "9",
  key: "JD",
  ...
  items: [
    ...
    { id: "specialties", name: "Primary specialty", tag: "must", input: "multi", options: [...CODING_SPECIALTIES.slice(0, 6), ...BILLING_SPECIALTIES.slice(0, 4), "Other"] },
    ...
    { id: "compmin", name: "Compensation — minimum (LPA)", tag: "must", input: "decimal", placeholder: "e.g. 3.5" },
    { id: "compmax", name: "Compensation — maximum (LPA)", tag: "must", input: "decimal", placeholder: "e.g. 5.5" },
    ...
    { id: "autoreject", name: "Auto-reject filters", tag: "opt", input: "multi", options: [
      "Education Mismatch (Life Science / Non Lifescience/Both)",
      "Missing mandatory keywords (CPC / ICD-10 / CPT / HCPCS)",
      "Experience (0–2 years for fresher drives)",
      "Location (preferred cities only)",
...
export const STAGE_BANNERS = {
  ...
  "4": { icon: "fa-solid fa-envelope-open-text", title: "Official hiring communication that candidates trust.", desc: "Use verified professional email addresses and official signatures for all candidate screening and interview coordination.", unlocks: ["Official interview invites", "Auto-signed email signatures", "Anti-phishing verification", "Direct candidate outreach"] },
...
export function getStage(id) {
  if (String(id).toLowerCase() === "9") return JOB_POSTING_STAGE;
